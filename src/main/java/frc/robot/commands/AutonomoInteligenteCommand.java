...
public class AutonomoInteligenteCommand extends Command {
    ...
    private boolean verificarNivelOcupado(int nivel) {
        ...
        switch(nivel) {
            case 4:
                return limelight.getHasTarget() && limelight.getTargetArea() > 2.0;
            case 3:
                return limelight.getHasTarget() && limelight.getTargetArea() > 1.5;
            case 2:
                return limelight.getHasTarget() && limelight.getTargetArea() > 1.0;
            default:
                return false;
        }
    }
